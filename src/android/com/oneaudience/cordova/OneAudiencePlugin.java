...
public class OneAudiencePlugin extends CordovaPlugin {
    ...
    public static final String ACTION_INIT_WITH_EULA = "initWithEula";
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        } else if (action.equals(ACTION_INIT_WITH_EULA)) {
            OneAudience.init(cordova.getActivity(), args.getString(0), args.getBoolean(1));
